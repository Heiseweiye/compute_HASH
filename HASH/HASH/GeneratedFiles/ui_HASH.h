...
public:
    ...
    QPushButton *Btn_openfile1;
    QPushButton *Btn_openfile2;
    QWidget *page_2;
...
"font: 9pt \"Consolas\";"));
        ...
        Butn_compute->setGeometry(QRect(580, 50, 101, 211));
...
"background-color: rgba(255, 255, 255, 200);"));
        ...
        input_plaintext_2->setGeometry(QRect(20, 310, 551, 141));
...
"font: 9pt \"Consolas\";"));
        ...
        btn_computeSHA1->setGeometry(QRect(580, 310, 101, 211));
...
"background-color: rgba(255, 255, 255, 200);"));
        ...
        plainTextEdit_MD5->setGeometry(QRect(20, 200, 551, 61));
...
"font: 9pt \"Consolas\";"));
        ...
        plainTextEdit_SHA1->setGeometry(QRect(20, 460, 551, 61));
        plainTextEdit_SHA1->setStyleSheet(QLatin1String("background-color: rgba(255, 255, 255, 200);\n"
"font: 9pt \"Consolas\";"));
        Btn_openfile1 = new QPushButton(page);
        Btn_openfile1->setObjectName(QStringLiteral("Btn_openfile1"));
        Btn_openfile1->setGeometry(QRect(20, 10, 112, 34));
        Btn_openfile1->setStyleSheet(QStringLiteral("background-color: rgba(255, 255, 255, 200);"));
        Btn_openfile2 = new QPushButton(page);
        Btn_openfile2->setObjectName(QStringLiteral("Btn_openfile2"));
        Btn_openfile2->setGeometry(QRect(20, 270, 112, 34));
        Btn_openfile2->setStyleSheet(QStringLiteral("background-color: rgba(255, 255, 255, 200);"));
...
"font: 10pt \"Agency FB\";"));
        ...
        menuBar->setGeometry(QRect(0, 0, 853, 30));
    ...
    void retranslateUi(QMainWindow *HASHClass)
    {
        ...
        Btn_openfile1->setText(QApplication::translate("HASHClass", "\346\211\223\345\274\200\346\226\207\344\273\266", 0));
        Btn_openfile2->setText(QApplication::translate("HASHClass", "\346\211\223\345\274\200\346\226\207\344\273\266", 0));
